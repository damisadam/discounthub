                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        for ($i=0; $i<count($results); $i++){ ?>
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <td><img src="uploads/product/<?php echo $results[$i]['product_image'];?>" width="200" height="200" /></td>
                                                <td><img src="uploads/product/<?php echo $results[$i]['product_image2'];?>" width="200" height="200" /></td>
                                            </tr>
                                            <tr>
